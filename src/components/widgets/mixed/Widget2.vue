<template>
  ...
  <div class="card card-xxl-stretch">
    ...
    <div :class="`bg-${widgetColor}`" class="card-header border-0 py-5">
      <h3 class="card-title fw-bolder text-white">项目统计</h3>
      ...
      <div class="card-p mt-n20 position-relative">
        ...
        <div class="row m-0">
          <div class="col bg-light-danger px-6 py-8 rounded-2 me-7">
            ...
            <a href="#" class="text-danger fw-bold fs-6 mt-2"> 项目成本 </a>
          </div>
          <div class="col bg-light-success px-6 py-8 rounded-2">
            <span class="svg-icon svg-icon-3x svg-icon-success d-block my-2">
              <inline-svg src="media/icons/duotune/communication/com010.svg" />
            </span>
            <a href="#" class="text-success fw-bold fs-6 mt-2"> 项目报告 </a>
          </div>
        </div>
        <!--end::Row-->
      </div>
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const chartOptions = {
      ...
      xaxis: {
        categories: ["六月", "七月", "八月", "九月", "十月", "十一月", "十二月"],
        axisBorder: {
          show: false,
        },
        axisTicks: {
