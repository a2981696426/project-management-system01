    ...
    <div class="aside-workspace my-5 p-5" id="kt_aside_wordspace">
      <div class="d-flex h-100 flex-column">
          ...
          <div class="tab-content">
            ...
            >
              <div class="m-0">
                ...
                <div class="m-0">
                  <h1 class="text-gray-800 fw-bold mb-6 mx-5">项目台</h1>
                  ...
                  <div class="mb-10">
                    <a href="#" class="custom-list d-flex align-items-center px-5 py-4">
                      ...
                      <div class="d-flex flex-column flex-grow-1">
                        ...
                        <span class="text-gray-400 fw-bold">负责人： 董向坤</span>
                      </div>
                    </a>
                    ...
                    <a href="#" class="custom-list d-flex align-items-center px-5 py-4">
                      ...
                      <div class="d-flex flex-column flex-grow-1">
                        ...
                        <span class="text-gray-400 fw-bold">负责人： 周宏宾</span>
                      </div>
                    </a>
                    ...
                    <a href="#" class="custom-list d-flex align-items-center px-5 py-4">
                      ...
                      <div class="d-flex flex-column flex-grow-1">
                        ...
                        <span class="text-gray-400 fw-bold">负责人： 曹燕君</span>
                      </div>
                    </a>
                    ...
                    <a href="#" class="custom-list d-flex align-items-center px-5 py-4">
                      ...
                      <div class="d-flex flex-column flex-grow-1">
                        ...
                        <span class="text-gray-400 fw-bold">负责人： 张宪成</span>
                      </div>
                    </a>
                    ...
                    <a href="#" class="custom-list d-flex align-items-center px-5 py-4">
                      ...
                      <div class="d-flex flex-column flex-grow-1">
                        ...
                        <span class="text-gray-400 fw-bold">负责人： 于海川</span>
                      </div>
                    </a>
                    ...
                    >
                      ...
                      <div class="d-flex flex-column flex-grow-1">
                        ...
                        <span class="text-gray-400 fw-bold">负责人： 袁润生</span>
                      </div>
                    </a>
                    ...
                    >
                      ...
                      <div class="d-flex flex-column flex-grow-1">
                        ...
                        <span class="text-gray-400 fw-bold">负责人： 周宇涛</span>
                      </div>
                    </a>
                  </div>
                </div>
        ...
        <div class="flex-column-auto pt-10 px-5" id="kt_aside_secondary_footer">
          ...
          >
            <span class="btn-label"> 文档和帮助 </span>
